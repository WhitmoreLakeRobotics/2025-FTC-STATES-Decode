...
// Set up stuff for pedro path
    ...
    public static Pose gatelineupPose = new Pose(15, 72, Math.toRadians(180));
    public static Pose gateopenfrompickup2b = new Pose(6, 72, Math.toRadians(180));
    ...
    public void loop() {
        ...
        switch (currentStage) {
            ...
            case _30_Shoot1:
                if (!follower.isBusy()) {
                    if (runtime.milliseconds() >= 750) { //500
