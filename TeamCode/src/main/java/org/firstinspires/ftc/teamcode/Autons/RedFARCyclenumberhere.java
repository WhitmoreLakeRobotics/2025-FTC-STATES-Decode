...
@Disabled
@Autonomous(name = "RedFARCyclenumberhere", group = "Auton")
// @Autonomous(...) is the other common choice

public class RedFARCyclenumberhere extends OpMode {
        ...
        switch (currentStage){
            ...
            case _30_DriveToPickup1:
                if (runtime.milliseconds() >= 1000 || robot.sensors.Empty)     { //change or update maybe
                    ...
                    currentStage = stage._35_Turning1;
                }
                break;
            ...
            case _50_InterruptedBackup1:
                if (robot.driveTrain.getCmdComplete()){
                   InterruptedPickup(stage._55_Turning15);
            ...
            case _90_PickupCorner1:
                    PickupSetup(stage._100_InterruptedBackup2,24);
                break;
            ...
            case _150_InterruptedBackup3:
                InterruptedPickup(stage._155_Turning25);
                //currentStage = stage._150_InterruptedBackup3;
                break;
            ...
            case _155_Turning25:
                if(robot.driveTrain.getCmdComplete()){
                    robot.driveTrain.cmdTurn(0,0.35);
                    currentStage = stage._160_BackToLaunch3;
                }
                break;
            ...
            case _190_PickupCorner2:
                PickupSetup(stage._200_InterruptedBackup4,24);
                break;
            ...
            case _250_QuickScaryDeath:
                if(robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.CmdDrive(24,90,0.50,90);
